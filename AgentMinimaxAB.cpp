...
AgentMinimaxAB::AgentMinimaxAB(bool isPlayer1, long long* totalComputationPointer) : isPlayer1(isPlayer1) {
...
int AgentMinimaxAB::heuristicEvaluation(BoardState state) {
